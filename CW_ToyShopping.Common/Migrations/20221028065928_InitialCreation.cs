        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEnble = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PRACTIICALNAME = table.Column<string>(maxLength: 20, nullable: true),
                    ...
                    NumberID = table.Column<string>(maxLength: 50, nullable: true),
                    BRIEF = table.Column<string>(maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BIRTHDATA = table.Column<DateTimeOffset>(maxLength: 40, nullable: false),
                    EMAIL = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SYS_AUTHOR", x => x.AuthorID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SYS_BOOK", x => x.BOOKID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RootIntroduction = table.Column<string>(maxLength: 50, nullable: true),
                    IsEnble = table.Column<bool>(nullable: false),
                    CREATEPERSON = table.Column<string>(maxLength: 50, nullable: true),
                    CREATEDATE = table.Column<DateTimeOffset>(nullable: false),
                    UPDATEPERSON = table.Column<string>(maxLength: 50, nullable: true),
